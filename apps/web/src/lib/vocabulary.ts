...
const SWE_VOCAB: Vocabulary = {
  ...
  tasksLabel: "Tasks",
  projectSingular: "workspace",
  projectPlural: "workspaces",
  newProjectPlaceholder: "New workspace name",
  projectDocsLabel: "Workspace Documents",
  projectDocsDescription: "Documents scoped to this workspace. Chat with these docs via the bottom bar.",
  uploadSubtitle: "Upload source documents for this workspace",
  taskSingular: "task",
  taskPlural: "tasks",
  statusLabels: {},
...
const KNOWLEDGE_VOCAB: Vocabulary = {
  ...
  newProjectPlaceholder: "New workspace name",
  projectDocsLabel: "Workspace Documents",
  projectDocsDescription: "Documents for this workspace. Chat via the bottom bar.",
  uploadSubtitle: "Upload source documents for this workspace",
};
