...
mod tests {
    ...
    #[test]
    fn auto_case_insensitive_returns_none() {
        assert_eq!(SandboxMode::from_str_or_auto("AUTO"), None);
        assert_eq!(SandboxMode::from_str_or_auto("Auto"), None);
    }
    ...
    fn unknown_value_returns_none() {
        ...
        assert_eq!(SandboxMode::from_str_or_auto("nspawn"), None);
    }
}
